...
struct Fourier {
    ...
    static func getCn(N: Int, path: [Complex<Double>]) -> [Int: Complex<Double>] {
    ...
    static func getApprox(N: Int, path: [Complex<Double>], c: [Int: Complex<Double>]) -> [Complex<Double>] {
    ...
    static func transform(N: Int, points: [[Double]]) -> [[Double]] {
